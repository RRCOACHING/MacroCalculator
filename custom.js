/*-------------------------------------------------------------------------------------
Template: Oceanitpark - The complete documentation template
Version:    1.0
Author: Oceanitpark
-------------------------------------------------------------------------------------*/
/*
...
jQuery(function ($) {
  ...
  /* slide List active color add*/
  $("ul li.side-list").on("click", function(){
    $("ul li.side-list").removeClass("active");
    $(this).addClass("active");
  })
  /* slide List active color close*/
